...
export default function MagiaGrowLanding() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen">
            <div className="space-y-8">
              {/* Badge */}
              <div className="inline-flex items-center bg-gradient-to-r from-rose-500 to-rose-600 text-white px-6 py-3 rounded-full text-sm font-bold shadow-lg">
                <span className="mr-2">✨</span>
                FÓRMULA EXCLUSIVA APROVADA PELA ANVISA
              </div>
              ...
              {/* Social Proof */}
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-l-4 border-amber-500 p-6 rounded-xl shadow-lg">
              ...
              {/* Price Box */}
              <div className="bg-white rounded-2xl p-8 border border-rose-200 shadow-xl">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <div className="text-gray-500 line-through text-lg">De R$ 249,90</div>
                    <div className="text-4xl lg:text-5xl font-black text-gray-900">R$ 139,90</div>
                    <div className="text-rose-600 font-bold text-lg">12x de R$ 11,66 sem juros</div>
                  </div>
                  <div className="bg-gradient-to-r from-red-500 to-red-600 text-white px-6 py-3 rounded-full text-xl font-bold shadow-lg animate-pulse">
                    44% OFF
                  </div>
                </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                  <p className="text-green-700 font-semibold text-center">
                    💳 PIX com 15% OFF: <span className="text-2xl font-black">R$ 118,92</span>
                  </p>
                </div>
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-rose-600 to-rose-800 hover:from-rose-700 hover:to-rose-900 text-white px-12 py-6 text-xl font-black w-full shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
                >
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-green-50 p-4 rounded-xl border border-green-200 text-center">
                  <div className="text-green-600 font-bold text-sm mb-1">✓ FRETE GRÁTIS</div>
                  <div className="text-xs text-gray-600">Todo Brasil</div>
                </div>
                <div className="bg-blue-50 p-4 rounded-xl border border-blue-200 text-center">
                  <div className="text-blue-600 font-bold text-sm mb-1">✓ GARANTIA 30 DIAS</div>
                  <div className="text-xs text-gray-600">Satisfação total</div>
                </div>
                <div className="bg-purple-50 p-4 rounded-xl border border-purple-200 text-center">
                  <div className="text-purple-600 font-bold text-sm mb-1">✓ PAGAMENTO SEGURO</div>
            ...
            <div className="relative flex justify-center">
              <div className="relative">
                ...
                />
                {/* Floating elements */}
                <div className="absolute -top-4 -right-4 bg-rose-500 text-white px-4 py-2 rounded-full text-sm font-bold animate-bounce">
                  90 Cápsulas
                </div>
                <div
                  className="absolute -bottom-4 -left-4 bg-amber-500 text-white px-4 py-2 rounded-full text-sm font-bold animate-bounce"
      ...
      {/* Carousel Section */}
      <section className="py-4 bg-gradient-to-r from-rose-600 to-rose-700 text-white overflow-hidden">
        <div className="relative">
          <div className="flex animate-scroll whitespace-nowrap">
            <div className="flex items-center gap-8 px-8">
              <span className="text-lg font-bold">PRODUTO VEGANO</span>
              <span className="text-amber-300">•</span>
              <span className="text-lg font-bold">FERRO E VITAMINA B12</span>
              <span className="text-amber-300">•</span>
              <span className="text-lg font-bold">MAIS VOLUME</span>
              <span className="text-amber-300">•</span>
              <span className="text-lg font-bold">MENOS QUEDA</span>
              <span className="text-amber-300">•</span>
              <span className="text-lg font-bold">PRODUTO VEGANO</span>
              <span className="text-amber-300">•</span>
              <span className="text-lg font-bold">FERRO E VITAMINA B12</span>
      ...
      <section className="py-16 bg-gradient-to-r from-rose-600 to-rose-700 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="flex items-center justify-center gap-4 mb-6">
            <Clock className="h-10 w-10 text-amber-300 animate-pulse" />
            <h2 className="text-4xl font-bold">OFERTA RELÂMPAGO!</h2>
          </div>
          <p className="text-2xl mb-8">
            Apenas <span className="text-amber-300 font-bold text-3xl">23 unidades</span> restantes com 50% OFF
          </p>
          <div className="flex justify-center gap-8 mb-8">
            <div className="text-center bg-white/20 rounded-lg p-4 backdrop-blur-sm">
              <div className="text-4xl font-bold text-amber-300">08</div>
              <div className="text-sm font-medium">HORAS</div>
            </div>
            <div className="text-center bg-white/20 rounded-lg p-4 backdrop-blur-sm">
              <div className="text-4xl font-bold text-amber-300">47</div>
              <div className="text-sm font-medium">MINUTOS</div>
            </div>
            <div className="text-center bg-white/20 rounded-lg p-4 backdrop-blur-sm">
              <div className="text-4xl font-bold text-amber-300">23</div>
              <div className="text-sm font-medium">SEGUNDOS</div>
            </div>
          </div>
          <Button
            size="lg"
            className="bg-amber-400 hover:bg-amber-500 text-gray-900 px-12 py-6 text-xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-300"
          >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-16">
            <div className="text-center group">
              <div className="mb-6 transform group-hover:scale-110 transition-transform duration-300">
                <img src="/images/benefit-hair.png" alt="Beleza Natural" className="w-20 h-20 mx-auto" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Beleza Natural</h3>
            ...
            <div className="text-center group">
              <div className="mb-6 transform group-hover:scale-110 transition-transform duration-300">
                <img src="/images/benefit-health.png" alt="Saúde Completa" className="w-20 h-20 mx-auto" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Saúde Completa</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center group">
              <div className="mb-6 transform group-hover:scale-110 transition-transform duration-300">
                <img src="/images/benefit-quality.png" alt="Qualidade Garantida" className="w-20 h-20 mx-auto" />
              </div>
            ...
            <div className="text-center group">
              <div className="mb-6 transform group-hover:scale-110 transition-transform duration-300">
                <img src="/images/benefit-natural.png" alt="Ingredientes Naturais" className="w-20 h-20 mx-auto" />
              </div>
            ...
            <div className="text-center group">
              <div className="mb-6 transform group-hover:scale-110 transition-transform duration-300">
                <img src="/images/benefit-science.png" alt="Base Científica" className="w-20 h-20 mx-auto" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Base Científica</h3>
              <p className="text-gray-600">
          ...
          <div className="text-center">
            <Button
              size="lg"
              onClick={() => document.getElementById("ofertas")?.scrollIntoView({ behavior: "smooth" })}
              className="bg-rose-600 hover:bg-rose-700 text-white px-12 py-6 text-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              EXPERIMENTAR MAGIA GROW AGORA
              <ArrowRight className="ml-3 h-6 w-6" />
            </Button>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <Badge className="mb-6 bg-gradient-to-r from-rose-600 to-rose-700 text-white px-6 py-2">
              RESULTADOS REAIS
            </Badge>
          ...
          <div className="text-center">
            <Button
              size="lg"
              className="bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white px-12 py-6 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300"
            >
      ...
      <section className="py-24 bg-gradient-to-b from-rose-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            {/* Ingredients Card */}
            <div>
              <Badge className="mb-6 bg-rose-100 text-rose-700 px-6 py-2 text-sm font-semibold">
                COMPOSIÇÃO PREMIUM
              </Badge>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="bg-rose-50 p-4 rounded-lg">
                      <h4 className="font-bold text-rose-700 mb-2">Vitaminas Essenciais</h4>
                      <p className="text-gray-600">B2, B6, B12, C, D para nutrição completa</p>
                    </div>
                    <div className="bg-amber-50 p-4 rounded-lg">
                      <h4 className="font-bold text-amber-700 mb-2">Minerais Premium</h4>
            ...
            {/* Usage Instructions */}
            <div>
              <Badge className="mb-6 bg-amber-100 text-amber-700 px-6 py-2 text-sm font-semibold">MODO DE USO</Badge>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Como Usar Para{" "}
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-lg border border-rose-100">
                  <div className="w-10 h-10 bg-rose-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-rose-600 font-bold">1</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Tome 3 cápsulas por dia</h4>
                    <p className="text-gray-600">Preferencialmente junto com as refeições principais</p>
                  </div>
                </div>

                <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-lg border border-amber-100">
                  <div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-amber-600 font-bold">2</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Use por no mínimo 90 dias</h4>
                    <p className="text-gray-600">Para resultados visíveis e duradouros na beleza</p>
                  </div>
                </div>

                <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-lg border border-green-100">
                  <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-green-600 font-bold">3</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Mantenha a regularidade</h4>
                    <p className="text-gray-600">Consistência é a chave para uma transformação completa</p>
                  </div>
                </div>
              </div>

              <div className="mt-8 p-6 bg-gradient-to-r from-rose-50 to-amber-50 rounded-xl border border-rose-200">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Fortalece os fios desde a raiz</h4>
                    <p className="text-gray-600">Nutrição profunda que chega até o folículo capilar</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Melhora a elasticidade da pele</h4>
                    <p className="text-gray-600">Colágeno natural para uma pele mais firme e jovem</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-rose-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Acelera o crescimento das unhas</h4>
                    <p className="text-gray-600">Queratina e biotina para unhas mais fortes e saudáveis</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Reduz a queda capilar em 85%</h4>
                    <p className="text-gray-600">Resultado comprovado em estudos clínicos</p>
                  </div>
                </div>
              </div>
              <Button
                size="lg"
                onClick={() => document.getElementById("ofertas")?.scrollIntoView({ behavior: "smooth" })}
                className="bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white px-10 py-6 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                EXPERIMENTAR AGORA
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-rose-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-6 bg-rose-100 text-rose-700 px-6 py-2 text-sm font-semibold">AVALIAÇÕES REAIS</Badge>
            <h2 className="text-5xl font-bold text-gray-900 mb-6">
              Mais de{" "}
              <span className="bg-gradient-to-r from-rose-600 to-rose-700 bg-clip-text text-transparent">
                10.000 Clientes
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="ml-4 text-2xl font-bold text-gray-900">4.9/5</span>
            </div>
            <p className="text-xl text-gray-600">Baseado em 2.847 avaliações verificadas</p>
          </div>
            ...
            <Card className="border-rose-200 bg-white shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardContent className="p-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">Maria Clara Santos</div>
            ...
            <Card className="border-rose-200 bg-white shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardContent className="p-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">Ana Silva Oliveira</div>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-rose-400 to-pink-600 rounded-full flex items-center justify-center">
                    <span className="font-bold text-white">JF</span>
                  </div>
                  <div>
                    <div className="font-bold text-gray-900">Juliana Ferreira</div>
          ...
          <div className="text-center">
            <Button
              ...
              className="bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white px-12 py-6 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              JUNTAR-SE ÀS CLIENTES SATISFEITAS
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </div>
        </div>
      ...
      {/* Offers Section */}
      <section
        className="py-24 bg-gradient-to-br from-rose-600 via-rose-700 to-rose-800 relative overflow-hidden"
        id="ofertas"
      >
        <div className="absolute inset-0 bg-black/10"></div>
        <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-2xl">
                  <div className="relative">
                    <img
                      ...
                      alt="Magia Grow - Suplemento Capilar"
                      className="w-full max-w-md mx-auto object-contain transition-all duration-300"
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-3 justify-center">
                  <div
                    className={`w-20 h-20 bg-white rounded-lg p-2 border-2 cursor-pointer transition-colors ${
              ...
              <div className="bg-rose-700 rounded-2xl p-10 text-white">
                <div className="mb-8">
                  ...
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <span className="text-white/90 text-lg font-medium">156 avaliações</span>
                  </div>

                  {/* Price */}
                  <div className="mb-10">
                    <div className="text-5xl font-bold mb-3">R$ 139,90</div>
                    <div className="text-2xl text-rose-200 font-semibold">6x de R$ 23,32</div>
                  </div>
                </div>

                {/* Package Options */}
                <div className="mb-10">
                  <h3 className="text-2xl font-bold mb-6">Frascos para:</h3>

                  <div className="space-y-4">
                    {/* 1 Month */}
                    <div className="bg-rose-600 rounded-xl p-6 flex items-center justify-between">
                      <div>
                        <div className="font-bold text-xl">1 MÊS</div>
                        <div className="text-rose-200 text-lg">1 por R$ 139,90 cada</div>
                      </div>
                      <Button className="bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-full font-bold text-lg">
                        ADICIONAR
                      </Button>
                    </div>
                    ...
                    <div className="bg-rose-600 rounded-xl p-6 flex items-center justify-between">
                      <div>
                        <div className="font-bold text-xl">3 MESES COM 7% OFF</div>
                        <div className="text-rose-200 text-lg">3 por R$ 130,11 cada</div>
                      </div>
                      <Button className="bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-full font-bold text-lg">
                        ADICIONAR
                      </Button>
                    ...
                    <div className="bg-rose-600 rounded-xl p-6 flex items-center justify-between">
                      <div>
                        <div className="font-bold text-xl">6 MESES COM 10% OFF</div>
                        <div className="text-rose-200 text-lg">6 por R$ 125,91 cada</div>
                      </div>
                      <Button className="bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-full font-bold text-lg">
                        ADICIONAR
                      </Button>
                ...
                {/* Buy Button */}
                <Button className="w-full bg-green-500 hover:bg-green-600 text-white py-6 text-2xl font-bold rounded-full h-20 mb-8">
                  COMPRAR
                </Button>

                {/* Security Icons */}
                <div className="flex items-center justify-center gap-8 text-lg text-white/90">
      ...
      <section className="py-24 bg-gradient-to-b from-white to-rose-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-6 bg-rose-100 text-rose-700 px-6 py-2 text-sm font-semibold">DÚVIDAS FREQUENTES</Badge>
            <h2 className="text-5xl font-bold text-gray-900 mb-6">
              Perguntas{" "}
              <span className="bg-gradient-to-r from-rose-600 to-rose-700 bg-clip-text text-transparent">
                Mais Comuns
          ...
          <div className="text-center mt-12">
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white px-10 py-4 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300"
            >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-4xl font-bold text-amber-300">10.000+</span>
              </div>
              <p className="text-lg">Clientes Satisfeitas</p>
            </div>
            <div>
              <div className="flex items-center justify-center gap-2 mb-2">
                <Star className="h-8 w-8 text-amber-300" />
                <span className="text-4xl font-bold text-amber-300">4.9</span>
              </div>
            ...
            <div>
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="text-4xl font-bold text-amber-300">95%</span>
              </div>
      ...
      {/* Final CTA */}
      <section className="py-24 bg-gradient-to-br from-rose-600 via-rose-700 to-rose-800 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-10 max-w-md mx-auto mb-12 border border-white/20">
            <div className="text-center">
              <div className="text-lg text-amber-300 line-through mb-2">De R$ 197,00</div>
              <div className="text-5xl font-bold text-white mb-4">R$ 139,90</div>
              <div className="text-amber-300 font-bold text-xl mb-4">29% OFF por tempo limitado</div>
              <div className="text-white/80">ou 12x de R$ 11,66 sem juros</div>
            </div>
          </div>
          <Button
            size="lg"
            onClick={() => document.getElementById("ofertas")?.scrollIntoView({ behavior: "smooth" })}
            className="bg-amber-400 hover:bg-amber-500 text-gray-900 px-16 py-8 text-2xl font-bold mb-8 shadow-2xl hover:shadow-3xl transition-all duration-300"
          >
            COMPRAR AGORA COM 29% OFF
      ...
      {/* Footer */}
      <footer className="py-12 bg-rose-50 border-t border-rose-200">
        <div className="container mx-auto px-4 text-center">
          <div className="mb-6">
            <h3 className="text-2xl font-bold text-rose-600 mb-2">Magia Grow</h3>
            <p className="text-gray-600">Transformando vidas através da beleza natural</p>
          </div>
